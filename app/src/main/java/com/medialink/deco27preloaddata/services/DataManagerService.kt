package com.medialink.deco27preloaddata.services
...
import com.medialink.deco27preloaddata.pref.AppPreference
...
class DataManagerService : Service(), CoroutineScope {
    ...
    private fun preLoadRaw(): ArrayList<MahasiswaModel> {
        val mahasiswaModels = arrayListOf<MahasiswaModel>()
        var line: String?
