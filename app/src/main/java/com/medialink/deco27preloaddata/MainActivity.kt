...
import com.medialink.deco27preloaddata.services.DataManagerService
import com.medialink.deco27preloaddata.services.DataManagerService.Companion.CANCEL_MESSAGE
import com.medialink.deco27preloaddata.services.DataManagerService.Companion.FAILED_MESSAGE
import com.medialink.deco27preloaddata.services.DataManagerService.Companion.PREPARATION_MESSAGE
import com.medialink.deco27preloaddata.services.DataManagerService.Companion.SUCCESS_MESSAGE
import com.medialink.deco27preloaddata.services.DataManagerService.Companion.UPDATE_MESSAGE
...
class MainActivity : AppCompatActivity(), HandlerCallback {
    ...
    override fun updateProgress(progress: Long) {
        ...
        progress_main.progress = progress.toInt()
    }
